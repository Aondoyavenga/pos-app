...
const { getAllOrders, placeOrder, getOrderItems, removeOrderItem, getCustomerOrders, 
    getAllOrderItems, getSalesOrders, getPurchasesOrders, getOrderByStatus, removeOrder, 
    closeSalesOrders, handleCloseSales, getClosedSalesPeriodic } = require('../methods/orderMethod')
